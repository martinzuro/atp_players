...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create ranking' do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { player_id: @ranking.player_id, position: @ranking.position, ranking_date: @ranking.ranking_date, ranking_points: @ranking.ranking_points } }
    end
  ...
  test 'should update ranking' do
    patch ranking_url(@ranking), params: { ranking: { player_id: @ranking.player_id, position: @ranking.position, ranking_date: @ranking.ranking_date, ranking_points: @ranking.ranking_points } }
